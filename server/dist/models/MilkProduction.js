...
const MilkProductionSchema = new mongoose_1.Schema({
    farmerId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'User', required: true },
    cowId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Cow' },
...
exports.default = mongoose_1.default.model('MilkProduction', MilkProductionSchema);
